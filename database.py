...
def ارسل_بريد_تكليف(ايميل_المراقب, اسم_المراقب, تفاصيل_الحملة, هل_هو_قائد=False):
    """إرسال إيميل التكليف بالتفاصيل الكاملة"""
    try:
        ...
        subject = f"🔔 تكليف بمهمة رقابية جديدة: {تفاصيل_الحملة['group_name']}"
        ...
        نود إحاطتك بأنه تم تكليفك بمهام {المسمى} للحملة الميدانية التالية:
